...
export set CORE_PEER_GOSSIP_EXTERNALENDPOINT=192.168.23.248:7051
...
export set CORE_PEER_FILESYSTEMPATH=/home/fabric/go/src/github.com/qiushaoxi/fabric_alpha1_bootscript/fabric_peer_release/production
